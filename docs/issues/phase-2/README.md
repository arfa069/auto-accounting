...
| [028](./028-add-account-ledger-sync.md) | 增加账户级自动多端账本同步 | 进行中 | 011, 021, 023, 025, 027 | 离线优先、多设备同步、冲突处理与账号隔离 |
| [029](./029-support-manual-wechat-transfer-and-refund-ocr.md) | 支持微信转账与退款账单手动 OCR 补录 | 已完成 | 007, 016 | 补录已完成支付、转账与退款账单 |
