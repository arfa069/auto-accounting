...
- [`evidence/`](./evidence/)：169 份 Markdown（Perfetto SQL/Trace 分析 scratchpad 与证据说明）、11 份 Macrobenchmark JSON 和 1 份 Perfetto 配置，共 181 个脱敏证据文件。

## 原始二进制证据

截至 2026-07-20 批次 6 收口时，原始目录共有 518 个文件、2,406,248,428 bytes。其中 262 个 Perfetto Trace、APK 和截图共 2,400,429,004 bytes，未复制进仓库，原因如下：
