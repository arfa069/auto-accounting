...
internal fun com.bks.feature.categorization.AiCategorizationFailureReason.toAiSettingsMessage(): String =
    when (this) {
        com.bks.feature.categorization.AiCategorizationFailureReason.BACKEND_NOT_CONFIGURED ->
            "云端后端地址尚未配置"
        com.bks.feature.categorization.AiCategorizationFailureReason.INVALID_SESSION ->
            "登录状态已失效，请重新登录"
        com.bks.feature.categorization.AiCategorizationFailureReason.ACCOUNT_DELETION_PENDING ->
            "账号注销冷静期内，云端设置已暂停"
        com.bks.feature.categorization.AiCategorizationFailureReason.RATE_LIMITED ->
            "请求过于频繁，请稍后重试"
        com.bks.feature.categorization.AiCategorizationFailureReason.NETWORK_FAILURE ->
            "网络连接失败，云端 AI 设置未更改"
        com.bks.feature.categorization.AiCategorizationFailureReason.SERVICE_UNAVAILABLE ->
            "云端服务暂时不可用，设置未更改"
