...
private val BksColors = lightColorScheme(
...
private val BksTypography = Typography(
...
@Composable
fun BksTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = BksColors,
        typography = BksTypography,
        shapes = BksShapes
    ) { content() }
}
