...
private enum class IdentifierAttachMethod {
    Sms,
    PasswordMerge
}
...
private fun AccountSession.SignedIn.toCredentials(
    deletionState: AccountDeletionUiState
...
private fun AccountIdentityUiState.expectedIdentifierError(): String = when (targetIdentifierType) {
