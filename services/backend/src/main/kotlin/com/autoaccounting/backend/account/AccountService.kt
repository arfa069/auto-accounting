...
class AccountService(
    ...
    fun prepareMergeWithIdentifierPassword(
        ...
        identifier: String,
        password: String
    ): AccountResult<com.autoaccounting.api.MergePreviewResponseContract> = wechatService.prepareMergeWithIdentifierPassword(bearerToken, identifier, password)
    ...
    ): AccountResult<com.autoaccounting.api.IdentifierLinkPrepareResponseContract> = identifierService.prepareIdentifierLink(bearerToken, identifier, deviceId, ipAddress, replaceExisting)
