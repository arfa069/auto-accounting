...
fun SmsProvider.Companion.fromEnvironment(env: Map<String, String> = System.getenv()): SmsProvider {
    val provider = env["BKS_SMS_PROVIDER"].orEmpty().lowercase()
...
private fun fromWebhookEnvironment(env: Map<String, String>): SmsProvider {
    val url = env["BKS_SMS_WEBHOOK_URL"].orEmpty()
    val key = env["BKS_SMS_API_KEY"].orEmpty()
...
private fun Map<String, String>.aliyunPnvsSmsConfig(): AliyunPnvsSmsConfig? {
    val keyId = this["BKS_SMS_ALIYUN_ACCESS_KEY_ID"]
        ?: this["BKS_ALIYUN_ACCESS_KEY_ID"]
        ?: this["ALIYUN_ACCESS_KEY_ID"].orEmpty()
    val keySecret = this["BKS_SMS_ALIYUN_ACCESS_KEY_SECRET"]
        ?: this["BKS_ALIYUN_ACCESS_KEY_SECRET"]
        ?: this["ALIYUN_ACCESS_KEY_SECRET"].orEmpty()
    val signName = this["BKS_SMS_SIGN_NAME"].orEmpty()
    val templateCode = this["BKS_SMS_TEMPLATE_CODE"].orEmpty()
    ...
    return AliyunPnvsSmsConfig(
        ...
        signName = signName,
        templateCode = templateCode,
        schemeName = this["BKS_SMS_SCHEME_NAME"].orEmpty()
    )
}
