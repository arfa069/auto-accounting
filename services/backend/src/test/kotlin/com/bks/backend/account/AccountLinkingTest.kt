...
class AccountLinkingTest {
    ...
    fun preparesAndConfirmsEmailLinkingSuccessfully() {
        ...
        val linkTicket = ((prepRes as AccountResult.Success).value as com.bks.api.IdentifierLinkPrepareResponseContract.LinkTicketIssued).linkTicket
    ...
    fun preparingExactIdentifierAlreadyOnCurrentAccountIsIdempotent() {
        ...
        assertEquals(
            AccountResult.Success(com.bks.api.IdentifierLinkPrepareResponseContract.AlreadyLinked),
    ...
    fun replacesExistingEmailAfterVerifyingNewAddress() {
        ...
        val firstTicket = (
            firstPreparation.value as com.bks.api.IdentifierLinkPrepareResponseContract.LinkTicketIssued
        ).linkTicket
        ...
        val replacementTicket = (
            replacementPreparation.value as com.bks.api.IdentifierLinkPrepareResponseContract.LinkTicketIssued
        ).linkTicket
    ...
    fun pureWechatAccountRequiresPasswordWhenLinkingFirstIdentifier() {
        ...
        val registration = exchange.value.result as com.bks.api.WechatAuthResultContract.RegistrationRequired
    ...
    fun identifierLinkTicketExpiresAndCannotBeReplayed() {
        ...
        val expiredTicket = (
            expiredPreparation.value as com.bks.api.IdentifierLinkPrepareResponseContract.LinkTicketIssued
        ).linkTicket
        clock.advanceBy(com.bks.api.TICKET_VALIDITY_MILLIS + 1)
        ...
        val validTicket = (
            validPreparation.value as com.bks.api.IdentifierLinkPrepareResponseContract.LinkTicketIssued
        ).linkTicket
        val linked = service.confirmIdentifierLink(
            registered.value.token,
            validTicket,
