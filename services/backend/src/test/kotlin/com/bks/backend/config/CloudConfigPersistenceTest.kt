...
import com.bks.backend.account.AccountToken
import com.bks.backend.account.JdbcAccountStore
import com.bks.backend.account.MutableClock
...
class CloudConfigPersistenceTest {
    ...
    private fun accountService(databaseUrl: String, clock: MutableClock): AccountService {
        return AccountService(
            ...
            verificationCodeHasher = com.bks.backend.account.VerificationCodeHasher.forTests(),
            clock = clock
        )
    }
